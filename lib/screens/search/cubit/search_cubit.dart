...
class SearchCubit extends Cubit<SearchState> {
  ...
  }): _userRepository = userRepository, super(SearchState.initial());
  ...
  void searchUsers(String query) async {
    ...
    try {
      ...
      emit(state.copyWith(status: SearchStatus.error, failure: const Failure(message: 'Something went wrong. Please try again.')));
    }
  }
