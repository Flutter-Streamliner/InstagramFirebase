...
class CreatePostScreen extends StatelessWidget {
                      ...
                      child: Column(
                        ...
                        children: [
                          TextFormField(
                            ...
                            validator: (value) => value.trim().isEmpty ? 'Caption cannot be empty!' : null,
                          ),
  ...
  void _selectPostImage(BuildContext context) async {
    final pickedFile = await ImageHelper.pickImageFromGallery(context: context, cropStyle: CropStyle.rectangle, title: 'Post');
    if (pickedFile != null) {
